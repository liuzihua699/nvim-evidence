...
--- @param grade number
--- @param globalData GlobalData | nil
--- @return AlgoData
function algo(cardData, grade, globalData)
  ...
  if grade == -1 then
    ...
    local diffDay = (os.time() - tools.parseDate(lastReview, parse_format)) / 86400

    cardData.grade = grade
